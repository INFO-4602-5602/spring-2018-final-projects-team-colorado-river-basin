...
int placeImg = displayWidth/2 + 330; 
...
void setup () {
  ...
  String years = "Year"; 
  textSize(20);
  text(years, displayWidth - Xtext*2, Ytext - lineGap); 
...
//2018     
  ...
  while (myPort.available () > 1) {
    ...
    fill(0);
    textSize(20);
    text(percent, Xtext, Ytext - 90, 250, 100);
    ...
    String description = "This map shows snowpack measurements from the nearly 900 SNOTEL stations across the Western United States. Snowpack is measured as snow water equivalent, during March, which is how much water you would get if you instantly melted the snow. The data is represented as a percent of the historical 'normal' values from 1980 to 2010. Using the sink interface in front of you, navigate through time (1985 to 2018) and through the size of the snow pack (from 0% to 200% of the historical average).";
    fill(0);
    textSize(13);
    text(description, Xtext, 520, 320, 500);
